...
<main class="admin-caps-catalog__container">
        ...
        <table class="admin-caps-catalog__table text-center margin-auto">
            ...
            <tbody>
                <?php foreach ($this->capsCatalog as $capCatalog) : ?>
                    <tr>
                        <td><?php echo '<img src="medias/img/caps_collections/caps_img/' . htmlspecialchars($capCatalog["image"]) . '"class="admin-caps-catalog__img""' . '"alt="retro mania cap image"">'; ?></td>
                        <td><?php echo htmlspecialchars(ucwords($capCatalog['name'])) ?></td>
                        <td>$<?php echo htmlspecialchars($capCatalog['price']) ?></td>
                        <td><?php echo htmlspecialchars($capCatalog['quantity']) ?></td>
                        <td class="admin-caps-catalog__table-actions">
                            <a href="index.php?page=admin_cap_description&product_id=<?php echo htmlspecialchars($capCatalog['product_id']) ?>"><i class="fa-solid fa-circle-info cap-info"></i></a>
                            <a href="index.php?page=admin_edit_cap&product_id=<?php echo htmlspecialchars($capCatalog['product_id']) ?>"><i class="fa-solid fa-pencil"></i></i></a>
                            <a href="index.php?page=admin_delete_cap&product_id=<?php echo htmlspecialchars($capCatalog['product_id']) ?>"><i class="fa-solid fa-trash-can"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <article class="admin-add-product">
        <article class="admin-add-product__form">
            <form action="index.php?page=admin_add_cap" method="POST" id="admin-add-product__form-content">
    ...
    <nav>
        <ul class="admin__bottom-navs flex-center">
            <li><a href="index.php?page=admin_collections_list" id="admin-caps-catalog__previous-page">&laquo;</a></li>
            <li><a href="index.php?page=admin_collections_list"><i class="fa-solid fa-list" id="admin-caps-catalog__previous-link"></i></a></li>
            <li><a href="#"><i id="admin-products-list__current-page" class="fa-solid fa-clipboard-list"></i></a></li>
            <li><a href="index.php?page=admin_employees_list"><i class="fa-solid fa-users" id="admin-caps-catalog__next-link"></i></a></li>
            <li><a href="index.php?page=admin_winners_list"><i class="fa-solid fa-trophy"></i></a></li>
            <li><a href="index.php?page=admin_employees_list" id="admin-caps-catalog__next-page">&raquo;</a></li>
        </ul>
    </nav>
</main>