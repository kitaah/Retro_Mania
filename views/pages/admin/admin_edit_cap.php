...
<main class="admin-product-update__container">
    <article>
        ...
        <article class="admin-product-update__form">
            <form action="index.php?p=admin_update_cap" method="POST" id="admin-product-update__form-content">
                <h2 class="text-center">Update the product</h2>
                <input type="hidden" id="admin-product-update-product_id" name="product_id" value="<?= htmlspecialchars($this->cap['product_id']) ?>">

                <label for="admin-product-update-name" class="line-break-after">Name</label>
                <input type="text" id="admin-product-update-name" name="name" value="<?= htmlspecialchars($this->cap['name']) ?>">
                ...
                <input type="number" id="admin-product-update-price" name="price" step="any" value="<?= htmlspecialchars($this->cap['price']) ?>">
                <i class="fa-solid fa-circle-check check-form"></i>
                <i class="fa-regular fa-circle-xmark xmark-form"></i><br />

                <label for="admin-product-update-quantity" class="line-break-after">Quantity</label>
                <input type="number" id="admin-product-update-quantity" name="quantity" value="<?= htmlspecialchars($this->cap['quantity']) ?>">
                <i class="fa-solid fa-circle-check check-form"></i>
                <i class="fa-regular fa-circle-xmark xmark-form"></i><br />

                <label for="admin-product-update-collection_id" class="line-break-after">Collection code</label>
                <input id="admin-product-update-collection_id" type="number" name="collection_id" value="<?= htmlspecialchars($this->cap['collection_id']) ?>">
                <i class="fa-solid fa-circle-check check-form"></i>
                <i class="fa-regular fa-circle-xmark xmark-form"></i><br />

                <label for="admin-product-update-admin_contributor_id" class="line-break-after">Admin contributor ID</label>
                <input id="admin-product-update-admin_contributor_id" type="number" name="admin_contributor_id" value="<?= htmlspecialchars($this->cap['admin_contributor_id']) ?>">
                <i class="fa-solid fa-circle-check check-form"></i>
                <i class="fa-regular fa-circle-xmark xmark-form"></i><br />
                ...
                <i class="fa-solid fa-circle-check check-form"></i>
                <i class="fa-regular fa-circle-xmark xmark-form"></i><br />
                <textarea id="admin-product-update-description" name="description"><?= htmlspecialchars($this->cap['description']) ?></textarea>
    ...
    <nav>
        <ul class="admin__bottom-navs flex-center">
            <li><a href="index.php?p=admin_caps_catalog" id="admin-product-update__previous-page">&laquo;</a></li>
            <li><a href="index.php?p=admin_collections_list"><i class="fa-solid fa-list"></i></a></li>
            <li><a href="index.php?p=admin_caps_catalog"><i class="fa-solid fa-clipboard-list" id="product-update__previous-link"></i></a></li>
            <li><a href="index.php?p=admin_employees_list"><i class="fa-solid fa-users" id="product-update__next-link"></i></a></li>
            <li><a href="index.php?p=admin_employees_list"><i class="fa-solid fa-trophy"></i></a></li>
            <li><a href="index.php?p=admin_winners_list" id="admin-product-update__next-page">&raquo;</a></li>
        </ul>
    </nav>
</main>